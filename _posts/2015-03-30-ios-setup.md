...
To add support for your own domains ([see "Setting up a custom domain"](http://support.hokolinks.com/setting-up-a-custom-domain/)), setup the iOS SDK using `setupWithToken:customDomains:` as following:
